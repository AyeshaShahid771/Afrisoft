...
const buttonVariants = {
  variants: {
    default: "bg-royal-blue text-white hover:bg-azure-blue",
    destructive:
      "bg-destructive text-destructive-foreground hover:bg-destructive/90",
    outline:
      "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
    secondary: "bg-azure-blue text-white hover:bg-royal-blue",
    ghost: "hover:bg-pale-blue hover:text-accent-foreground",
