  ...
  return (
    <>
      ...
      <main className="bg-white md:min-h-screen">
        ...
        {/* Embedded Google Form (client component handles expansion after submit) */}
        <ContactFormEmbed src="https://docs.google.com/forms/d/e/1FAIpQLSdBTHNpYjpi-dD4U4o5BR0OVtnZnOUwzs9WswkicsFey2LfEg/viewform?embedded=true" />
