          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 items-start">
            <div className="col-span-1 md:col-span-5 md:order-2 md:col-start-8">
              <div className="w-full">
                <img
                  ...
                  className="w-full h-[220px] md:h-[420px] object-cover rounded-2xl mb-6 md:mb-0"
                />
              </div>
            </div>
            ...
            <div className="col-span-1 md:col-span-7 md:order-1">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-3xl font-extrabold text-deep-navy">
                  What We Offer
                </h3>
              </div>

              <p className="text-sm md:text-base text-gray-700 mb-6">
                We work with partners across academia, government, and industry
                to deliver research, policy and training that helps
                organisations develop responsible AI practices.
              </p>

              <div className="space-y-8">
                {offerings.map((o, idx) => (
                  <div key={o.title}>
                    <h4 className="font-semibold text-deep-navy text-lg">
                      {o.title}
                    </h4>
