        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="bg-white rounded-2xl p-6 md:p-12 shadow-xl">
            <div className="grid grid-cols-2 md:grid-cols-2 gap-8 items-start">
              <div>
                <h2 className="text-xl md:text-4xl font-extrabold text-deep-navy">
                  Our Expertise
                </h2>
                <p className="mt-4 text-sm md:text-base text-gray-700 max-w-3xl">
                  We design human-centred AI that is explainable, fair and
                  trusted. Below are the research areas where we focus our work.
                </p>

                <div className="mt-8 space-y-8">
                  <div className="flex items-start gap-6">
                    <div>
                      <h3 className="text-base md:text-xl font-semibold text-deep-navy">
                        Transparency & Explainability
                      </h3>
                      <p className="mt-2 text-sm md:text-base text-gray-700">
                        Designing AI systems that can be understood by end-users
                        and stakeholders.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6">
                    <div>
                      ...
                      <p className="mt-2 text-sm md:text-base text-gray-700">
                        Identifying and mitigating algorithmic bias to support
                  ...
                  <div className="flex items-start gap-6">
                    <div>
                      <h3 className="text-base md:text-xl font-semibold text-deep-navy">
                        Digital Twins & Personalized AI
                      </h3>
                      <p className="mt-2 text-sm md:text-base text-gray-700">
                        Exploring user-centric AI in healthcare, smart cities,
                        and industry, focusing on personalization and
                        sustainability.
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex justify-end md:justify-end items-start">
                <div className="rounded-xl shadow-lg md:rounded-none md:shadow-none md:overflow-visible md:h-auto">
                  <img
                    src="/expertise.jpeg"
                    alt="Team"
                    className="w-full md:w-[420px] md:h-[420px] object-contain md:rounded-none block"
                  />
                </div>
              </div>
            </div>
